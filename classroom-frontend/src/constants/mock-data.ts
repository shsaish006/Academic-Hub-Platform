...
export const MOCK_SUBJECTS: Subject[] = [
    {
        ...
        department: { id: 1, name: "Computer Science", description: "Computer Science" },
    ...
    },
    {
        ...
        code: "MATH201",
        name: "Calculus II",
        department: { id: 2, name: "Math", description: "Math" },
    ...
    },
    {
        ...
        department: { id: 3, name: "English", description: "English" },
